        ...
        {isLogin ? (
          <div>
            ...
            <form onSubmit={e => e.preventDefault()}>
              ...
              <a
                href="/welcome.html"
                className="hover:cursor-pointer w-full bg-blue-600 text-white py-2.5 px-4 rounded-lg font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors shadow-sm inline-block text-center">
                Entrar
              </a>
            </form>
          </div>
